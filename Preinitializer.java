...
class Preinitializer {
    ...
    public static final String BREAKDOWN_INPUT_FILENAME = "breakdown3-117.chk"; // name of file to which we write the edge breakdowns
    public static final String BREAKDOWN_OUTPUT_FILENAME = "breakdown2-117.chk"; // name of file to which we write the edge breakdowns
