...
class Preinitializer {
    ...
    public static final String BREAKDOWN_INPUT_FILENAME = "breakdowns0.chk"; // name of file to which we write the edge breakdowns
    public static final String BREAKDOWN_OUTPUT_FILENAME = "breakdowns1.chk"; // name of file to which we write the edge breakdowns
